...
icon = Image.open("Homee.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By M GOBINATH",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *GOBINATH*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://wallpapers.com/images/hd/wavy-red-color-lines-sqbtwm318wxbdogp.webp");
...
config = mysql.connector.connect(
    ...
    user="root",
    password="Gobi_7890",
    database="bizcard"  # Specify the database name
)
